...
//                 let homa = Arc::clone(&self);
//                 join_handles.push(tokio::spawn(homa.application_listener()));
...
//     pub async fn incoming_datagram_listener(
//         self: Arc<Self>,
//         mut incoming_socket: TransportReceiver,
//     ) {
...
//     pub async fn application_listener(self: Arc<Self>) {
//         println!("started application_listener");
...
//                 HomaRegistrationMessage::from_unix_stream(&mut stream).await
//             {
...
//                 let homa = Arc::clone(&self);
//                 tokio::spawn(
//                     homa.receiver_application_handler(receiver_application_handler_rx, tx),
//                 );

//                 let stream_clone = stream.try_clone().unwrap();
//                 let homa = Arc::clone(&self);
//                 tokio::spawn(homa.receiver_application_writer(stream_clone, rx));

//                 let homa = Arc::clone(&self);
//                 tokio::spawn(homa.transmitter_application_handler(stream));
//             }
//         }
//     }

//     pub async fn outgoing_datagram_transmitter(
//         self: Arc<Self>,
//         mut outgoing_socket: TransportSender,
//     ) {
...
//                 tokio::spawn(self_clone.receiver_message_handler(
//                     handler_rx,
//                     datagram,
//                     outgoing_datagram_transmitter_tx,
...
//     pub async fn receiver_application_writer(
//         self: Arc<Self>,
//         mut stream: UnixStream,
//         rx: Receiver<HomaMessage>,
//     ) {
//         println!("Started receiver_application_writer");
...
//     pub async fn transmitter_application_handler(self: Arc<Self>, mut stream: UnixStream) {
//         println!("Started transmitter_application_writer");
...
//             tokio::spawn(self_clone.transmitter_message_handler(
//                 homa_message,
...
//     pub async fn receiver_message_handler(
//         self: Arc<Self>,
...
//     pub async fn transmitter_message_handler(
//         self: Arc<Self>,
